...
class TestResolveCommand:
    ...
    def test_goal_prompt_typo_aliases_do_not_resolve(self):
        assert resolve_command("goal_promt") is None
        assert resolve_command("goal_promt_oneshot") is None
...
class TestGatewayKnownCommands:
    ...
    def test_goal_prompt_oneshot_available_in_gateway(self):
        assert "goal-prompt-oneshot" in GATEWAY_KNOWN_COMMANDS
        assert "goal_prompt_oneshot" in GATEWAY_KNOWN_COMMANDS
...
class TestTelegramBotCommands:
    ...
    def test_goal_prompt_oneshot_appears_as_telegram_safe_command(self):
        names = {name for name, _ in telegram_bot_commands()}
        assert "goal_prompt_oneshot" in names
